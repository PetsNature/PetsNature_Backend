...
public interface PublicacionRepository extends JpaRepository<Publicacion,Long> {
    ...
    @Query("SELECT NEW pe.com.upao.grupo3.petsnature.serializers.PublicacionSerializer(p.fecha,p.hora,p.contenido,p.img,p.enlace,p.usuario.nombre,p.usuario.imgPerfil) FROM Publicacion p WHERE p.categoria=:categoria and p.tipoMascota=:tipoMascota and p.tema=:tema")
    ...
    @Query("SELECT NEW pe.com.upao.grupo3.petsnature.serializers.PublicacionSerializer(p.fecha,p.hora,p.contenido,p.img,p.enlace,p.usuario.nombre,p.usuario.imgPerfil) FROM Publicacion p WHERE p.categoria=:categoria and p.tipoMascota=:tipoMascota and p.raza=:raza and p.tema=:tema")
    ...
    @Query("SELECT NEW pe.com.upao.grupo3.petsnature.serializers.PublicacionSerializer(p.fecha,p.hora,p.contenido,p.img,p.enlace,p.usuario.nombre,p.usuario.imgPerfil) FROM Publicacion p WHERE p.categoria=:categoria and p.tema=:tema")
